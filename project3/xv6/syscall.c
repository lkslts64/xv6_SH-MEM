...
//--------------------------------------
int
sem_argptr(int n, struct sem_t **pp, int size)
{
  int i;
  //struct proc *curproc = myproc();
...
[SYS_shmremove]	sys_shmremove,
[SYS_sem_init]	sys_sem_init,
[SYS_sem_up]	sys_sem_up,
[SYS_sem_down]	sys_sem_down,
[SYS_check_sem] sys_check_sem,
